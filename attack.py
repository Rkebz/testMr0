...
def send_http_request(target_url, num_requests=1000, data=''):
    for _ in range(num_requests):
        ...
        try:
            ...
            print("Error:", e)
        time.sleep(0.1)  # انتظار 0.1 ثانية بين كل طلب لزيادة السرعة
...
if data_file_path:
    ...
    send_http_request(target_url, num_requests=10000, data=data*100)  # تكرار البيانات 100 مرة وزيادة عدد الطلبات
else:
